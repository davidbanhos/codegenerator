...
public class WfMessageTest {
	...
	public void testCreateWfTradeRule() throws IOException {
		...
		Template template = Velocity.getTemplate(velocityTestConfig.templatesDir() + "wfMessageRule.vm");
		...
		Assert.assertTrue(clazz
				.contains("public class CustomMessageRule implements WfMessageRule"));
	}
}
